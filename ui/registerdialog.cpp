 ...
 */
RegisterDialog::RegisterDialog(QWidget *parent, int flag) : QDialog(parent), ui(new Ui::registerdialog) {
    ui->setupUi(this);
...
void RegisterDialog::init() {
    ...
    connect(defaultBtn, &buttons::DefaultButton::clicked, [this] {
        close();
    });
